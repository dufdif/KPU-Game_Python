...
def mSearch():
    ...
    for i in range(0,len(그래프용)):
        canvas.create_rectangle(5+i*17, 15+(그래프용[i]*1000), 15+i*17, 215,fill='green',outline='violet')
...
def Menu():
    ...
    title2=Label(app,text='※ 방사능 그래프 ※',relief='groove',font='bold 16')
    title2.place(x=940,y=200)
    minlabel=Label(app,text=0.000)
    maxlabel=Label(app,text=0.200,fg='red')
    centerlabel=Label(app,text=0.100,fg='blue')
    centerlabel.place(x=800,y=400)
    l1=Label(app,text=0.050,fg='green')
    l1.place(x=800,y=450)
    l2=Label(app,text=0.150,fg='orange')
    l2.place(x=800,y=350)
    minlabel.place(x=800,y=500)
    maxlabel.place(x=800,y=300)
    canvas=Canvas(app,width=300,height=225,bg='silver')
